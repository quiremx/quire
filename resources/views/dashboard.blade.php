<x-slider>
    ...
    <div class=" text-primary-foreground min-h-screen p-5 ">
        <div class="bg-white p-6 rounded-xl mb-8 shadow-lg border-l-4  border-accent">
            <h2 class="text-2xl font-semibold mb-4 text-accent">Resumen de cuenta</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <a href="/transferencias">
            <div class="bg-white text-gray-900 p-4 rounded-xl shadow-md hover:shadow-lg transition transform hover:scale-105">
            ...
            <a href="/pagosyservicios">
                <div class="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition transform hover:scale-105">
            ...
            <a href="/historial">
                <div class="bg-white p-4  text-gray-900 rounded-xl shadow-md hover:shadow-lg transition transform hover:scale-105">
